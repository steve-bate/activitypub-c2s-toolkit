import type { TestCaseContext, TestCaseResult, TestRunOptions } from '@/testing/core/types'

export function createTestContext(runId: string, runParameters: TestRunOptions['runParameters']): TestCaseContext {
