    ...
    <div class="px-4 py-3 flex items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-1">
        ...
        <RouterLink
          to="/tests"
          title="Test Harness"
          class="px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-100 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        >
          Tests
        </RouterLink>
